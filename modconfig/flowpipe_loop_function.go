...
func (l *LoopFunctionStep) UpdateInput(input Input, evalContext *EvalContext) (Input, error) {
...
func (l *LoopFunctionStep) SetAttributes(hclAttributes hcl.Attributes, evalContext *EvalContext) hcl.Diagnostics {
