...
type ResourceMetadata struct {
	ResourceName string `column:"resource_name,string" `
	// mod short name
	ModName          string `column:"mod_name,string" `
	FileName         string `column:"file_name,string" `
	...
	SourceDefinition string `column:"source_definition,string" `
	ModFullName      string
