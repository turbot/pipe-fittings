...
func (w *Workspace[T]) handleFileWatcherEvent(ctx context.Context) {
...
func (w *Workspace[T]) ReloadResourceMaps(ctx context.Context) (modconfig.ResourceMapsI, modconfig.ResourceMapsI, error_helpers.ErrorAndWarnings) {
	w.LoadLock()
	defer w.LoadUnlock()
