...
func (c *TrelloConnection) Resolve(ctx context.Context) (modconfig.PipelingConnection, error) {
...
func (c *TrelloConnection) Equals(otherConnection modconfig.PipelingConnection) bool {
