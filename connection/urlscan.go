...
func (c *UrlscanConnection) Resolve(ctx context.Context) (modconfig.PipelingConnection, error) {
	if c.APIKey == nil {
...
func (c *UrlscanConnection) Equals(otherConnection modconfig.PipelingConnection) bool {
