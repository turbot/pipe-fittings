...
func (c *JumpCloudConnection) Resolve(ctx context.Context) (modconfig.PipelingConnection, error) {
	if c.APIKey == nil {
...
func (c *JumpCloudConnection) Equals(otherConnection modconfig.PipelingConnection) bool {
