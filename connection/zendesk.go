...
func (c *ZendeskConnection) Resolve(ctx context.Context) (modconfig.PipelingConnection, error) {
...
func (c *ZendeskConnection) Equals(otherConnection modconfig.PipelingConnection) bool {
