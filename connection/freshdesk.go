...
func (c *FreshdeskConnection) Resolve(ctx context.Context) (modconfig.PipelingConnection, error) {
...
func (c *FreshdeskConnection) Equals(otherConnection modconfig.PipelingConnection) bool {
