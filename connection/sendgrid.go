...
func (c *SendGridConnection) Resolve(ctx context.Context) (modconfig.PipelingConnection, error) {
	if c.APIKey == nil {
...
func (c *SendGridConnection) Equals(otherConnection modconfig.PipelingConnection) bool {
