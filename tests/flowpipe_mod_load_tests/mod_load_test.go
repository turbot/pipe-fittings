...
func (suite *FlowpipeModLoadTestSuite) TestInputStepContainsNotifyBlockThatHasVarOnIt() {
	...
	workspace, errorAndWarning := workspace.Load(suite.ctx, "./mods/step_with_notify_and_var_default", map[string]modconfig.Credential{}, ".hcl", ".sp")
...
func (suite *FlowpipeModLoadTestSuite) TestNotifyDependsAnotherStep() {
	...
	workspace, errorAndWarning := workspace.Load(suite.ctx, "./mods/notify_depends_another_step", map[string]modconfig.Credential{}, ".hcl", ".sp")
	assert.Nil(errorAndWarning.Error)
...
func (suite *FlowpipeModLoadTestSuite) TestNotifyWithRuntimeParam() {
	...
	workspace, errorAndWarning := workspace.Load(suite.ctx, "./mods/notify_with_runtime_param", map[string]modconfig.Credential{}, ".hcl", ".sp")
	assert.Nil(errorAndWarning.Error)
