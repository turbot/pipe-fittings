...
func (suite *FlowpipeModTestSuite) TestGoodMod() {
	...
	w, errorAndWarning := workspace.LoadWithParams(suite.ctx, "./good_mod", map[string]modconfig.Credential{}, map[string]modconfig.CredentialImport{}, ".fp")
...
func (suite *FlowpipeModTestSuite) TestModReferences() {
	...
	w, errorAndWarning := workspace.LoadWithParams(suite.ctx, "./mod_references", map[string]modconfig.Credential{}, map[string]modconfig.CredentialImport{}, ".fp")
...
func (suite *FlowpipeModTestSuite) TestModWithCreds() {
	...
	w, errorAndWarning := workspace.LoadWithParams(suite.ctx, "./mod_with_creds", credentials, map[string]modconfig.CredentialImport{}, ".fp")
...
func (suite *FlowpipeModTestSuite) TestModWithCredsWithContextFunction() {
	...
	w, errorAndWarning := workspace.LoadWithParams(suite.ctx, "./mod_with_creds_using_context_function", flowpipeConfig.Credentials, map[string]modconfig.CredentialImport{}, ".fp")
	assert.NotNil(w)
	assert.Nil(errorAndWarning.Error)
...
func (suite *FlowpipeModTestSuite) TestModDynamicCreds() {
	...
	w, errorAndWarning := workspace.LoadWithParams(suite.ctx, "./mod_with_dynamic_creds", credentials, map[string]modconfig.CredentialImport{}, ".fp")
...
func (suite *FlowpipeModTestSuite) TestModWithCredsResolved() {
	...
	w, errorAndWarning := workspace.LoadWithParams(suite.ctx, "./mod_with_creds_resolved", credentials, map[string]modconfig.CredentialImport{}, ".fp", ".fpc")
...
func (suite *FlowpipeModTestSuite) TestStepOutputParsing() {
	...
	w, errorAndWarning := workspace.LoadWithParams(suite.ctx, "./mod_with_step_output", map[string]modconfig.Credential{}, map[string]modconfig.CredentialImport{}, ".fp")
...
func (suite *FlowpipeModTestSuite) TestModDependencies() {
	...
	w, errorAndWarning := workspace.LoadWithParams(suite.ctx, "./mod_dep_one", map[string]modconfig.Credential{}, map[string]modconfig.CredentialImport{}, ".fp")
...
func (suite *FlowpipeModTestSuite) TestModDependenciesSimple() {
	...
	w, errorAndWarning := workspace.LoadWithParams(suite.ctx, "./mod_dep_simple", map[string]modconfig.Credential{}, map[string]modconfig.CredentialImport{}, ".fp")
...
func (suite *FlowpipeModTestSuite) TestModVariable() {
	...
	w, errorAndWarning := workspace.LoadWithParams(suite.ctx, "./mod_variable", map[string]modconfig.Credential{}, map[string]modconfig.CredentialImport{}, ".fp")
